...
@Table(name = "SEMESTER")
@NamedQueries({ 
//    The nameQueries are great in that as the are a ref to 
//    JPQL sripct so there is no need to write the hold script and 
//    just call the namedquerry
